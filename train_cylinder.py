...
dataset=[]
train_loader=MeshcylinderDataset('/home/fielddata/cylinderdata',mode='train')
...
root_logger = logger_setup(os.path.join('/home/test2', 'log.log'))
model.train()
...
for epoch in range(500):
   ...
   if(epoch==120):
      scheduler.step()   
torch.save(model.state_dict(),'/home/AMGNET/modelcylinder.pkl')   
##########################
# test
##########################
model=EncodeProcessDecode(output_size=3,
                 ...
                 num_layers=2,
                 message_passing_aggregator='sum', message_passing_steps=6).to(device)
model.load_state_dict(torch.load('/home/AMGNET/modelcylinder.pkl'))                 
